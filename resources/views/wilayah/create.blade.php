...
<script src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js"></script>
    ...
    <div class="max-w-4xl mx-auto bg-white p-8 rounded-xl shadow-xl">
        <header class="mb-6 border-b pb-4">
            ...
            <p class="text-sm text-gray-500">Klik pada peta untuk menentukan lokasi wilayah.</p>
        </header>
        ...
        <form action="{{ route('wilayah.store') }}" method="POST" id="wilayah-form">
            @csrf
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="nama_kabupaten" id="nama_kabupaten" value="{{ old('nama_kabupaten') }}" required
                        class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 border">
                </div>
