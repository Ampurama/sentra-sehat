...
@section('title', 'Tambah Data Kesehatan Anak dan Ibu Baru')
...
<div class="container mx-auto p-4 md:p-8">
    <div class="max-w-4xl mx-auto bg-white p-6 sm:p-8 rounded-3xl shadow-2xl">
        ...
        <header class="mb-8 border-b border-gray-200 pb-4">
            <h1 class="text-2xl sm:text-3xl font-extrabold text-blue-700">Formulir Tambah Data Kesehatan Anak dan Ibu Baru</h1>
            <p class="text-sm text-gray-600 mt-2">Lengkapi informasi kesehatan anak dan ibu untuk ditambahkan ke sistem.</p>
        </header>
        ...
        <form action="{{ route('kesehatan_anak_ibu.store') }}" method="POST">
            @csrf
            ...
            <section class="mb-8 p-4 sm:p-6 border border-blue-200 rounded-xl bg-blue-50/50 shadow-inner">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                    <div>
                        ...
                        <select name="child_vaccinations_complete" id="child_vaccinations_complete" class="mt-1 block w-full rounded-xl border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 border @error('child_vaccinations_complete') border-red-500 @enderror">
                            <option value="0" {{ old('child_vaccinations_complete') == '0' ? 'selected' : '' }}>Tidak</option>
                            <option value="1" {{ old('child_vaccinations_complete') == '1' ? 'selected' : '' }}>Ya</option>
                        </select>
                    ...
                    <div>
                        ...
                        <input type="number" name="maternal_checkups_count" id="maternal_checkups_count" class="mt-1 block w-full rounded-xl border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 border @error('maternal_checkups_count') border-red-500 @enderror" value="{{ old('maternal_checkups_count', 0) }}" min="0">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                    <div>
                        ...
                        <input type="number" name="birth_weight" id="birth_weight" class="mt-1 block w-full rounded-xl border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 border @error('birth_weight') border-red-500 @enderror" value="{{ old('birth_weight') }}" step="0.01" min="0">
                    ...
                    <div>
                        ...
                        <input type="date" name="last_checkup" id="last_checkup" class="mt-1 block w-full rounded-xl border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 border @error('last_checkup') border-red-500 @enderror" value="{{ old('last_checkup') }}">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="notes" id="notes" class="mt-1 block w-full rounded-xl border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 border @error('notes') border-red-500 @enderror" rows="3" placeholder="Catatan tambahan">{{ old('notes') }}</textarea>
            ...
            <div class="mt-10 flex flex-col-reverse sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-4">
                <a href="{{ route('kesehatan_anak_ibu.index') }}" class="w-full sm:w-auto px-6 py-3 border border-gray-300 rounded-xl text-gray-700 hover:bg-gray-100 transition duration-300 text-center">Batal</a>
